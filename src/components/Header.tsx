        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-gray-600 rounded-lg hover:bg-[var(--secondary-color-dark)] focus:ring-2 focus:ring-[var(--secondary-color)] focus:ring-offset-2 transition-colors"
            ...
            <button
              ...
              className="p-2 rounded-lg border border-gray-200 text-gray-600 hover:text-[var(--primary-color)] hover:border-[var(--primary-color)] focus:ring-2 focus:ring-[var(--primary-color)] focus:ring-offset-2 transition-colors"
              aria-label="Refresh"
              title="Refresh"
            >
          ...
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="flex flex-col space-y-2">
              ...
              <button
                ...
                className="w-full text-left px-4 py-3 bg-gray-600 text-white rounded-lg hover:bg-[var(--secondary-color-dark)] focus:ring-2 focus:ring-[var(--secondary-color)] focus:ring-offset-2 transition-colors"
              >
                Import/Export
              </button>
              <button
              ...
              <button
                ...
                className="w-full text-left px-4 py-3 border border-gray-200 rounded-lg text-gray-700 hover:text-[var(--primary-color)] hover:border-[var(--primary-color)] focus:ring-2 focus:ring-[var(--primary-color)] focus:ring-offset-2 transition-colors flex items-center space-x-2"
                aria-label="Refresh"
                title="Refresh"
              >
                <FiRefreshCcw className="text-lg" />
